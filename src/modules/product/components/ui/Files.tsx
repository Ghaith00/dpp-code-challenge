...
export function File({ key=0, name, size, url }: FilesProps) {
    return <div key={key} className='flex items-center p-3 mb-3.5 border border-gray-200 dark:border-gray-700 rounded-lg'>
